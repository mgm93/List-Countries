...
import com.mgm.countriesdetail.databinding.ItemCountry2Binding
import com.mgm.countriesdetail.models.CountryInfo


class CountriesAdapter(
    private val openCountryInfo: (
        binding: ItemCountry2Binding,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CountryViewHolder {
        val binding: ItemCountry2Binding =
            ItemCountry2Binding.inflate(LayoutInflater.from(parent.context), parent, false)
